...
public class Homepage extends BasePage {
    ...
    // --- New helper methods for TC_SC_005 ---
...
// In Homepage.java
    ...
    // In your Homepage.java (or wherever clickCheckout() is defined)
    /*public void clickCheckout() {
        try {
            WebElement checkoutBtn = driver.findElement(By.xpath("/html/body/header/div/div/div[3]/div/ul/li[2]/div/p/a[2]/strong")); // Adjust your locator
            checkoutBtn.click();
            logger.info("Clicked Checkout button successfully.");
        } catch (ElementNotInteractableException e) {
            logger.warn("Checkout button not interactable, attempting JS click.");
            JavascriptExecutor js = (JavascriptExecutor) driver;
            WebElement checkoutBtn = driver.findElement(By.xpath("/html/body/header/div/div/div[3]/div/ul/li[2]/div/p/a[2]/strong")); // same locator
            js.executeScript("arguments[0].click();", checkoutBtn);
            logger.info("Clicked Checkout button via JS successfully.");
        }
    }*/
...
// --- METHODS ---
   ...
   /* public void clickViewCartOption() {
        ...
        try {
            ...
            WebElement viewCartLink = wait.until(
                    ExpectedConditions.elementToBeClickable(By.xpath("//p[@class='text-right']/a[contains(text(),'View Cart')]"))
            );
            viewCartLink.click();
            logger.info("Clicked on 'View Cart' link from cart dropdown.");
        } catch (Exception e) {
    ...
    public void navigateDirectlyToCart() {
        try {
            WebElement cartLink = driver.findElement(By.xpath("//a[@title='Shopping Cart']"));
            cartLink.click();
            logger.info("Navigated directly to Shopping Cart page.");
        } catch (Exception e) {
   ...
   /* @FindBy(xpath = "/html/body/div[2]/div/div/div[3]/div[2]/a")
    ...
    // Clicks 'View Cart' link in success alert safely
    /*public void clickViewCartFromSuccessAlert() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            WebElement successAlert = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.alert-success")));
            ...
            throw new RuntimeException("Failed to click 'View Cart' link from success alert → " + e.getMessage(), e);
        }
    }*/
    ...
    public void addProductToCart(String productName) {
        try {
            ...
            try {
                WebElement addBtn = wait.until(ExpectedConditions.elementToBeClickable(By.id("button-cart")));
                addBtn.click();
    ...
    // Click a product dynamically by its visible name
    public void clickProductByName(String productName) {
        // Construct the full XPath using String.format

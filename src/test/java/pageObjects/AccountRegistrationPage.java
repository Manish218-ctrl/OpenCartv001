...
public class AccountRegistrationPage extends BasePage {
    ...
    @FindBy(xpath = "//div[contains(@class,'text-danger') and contains(text(),'Password confirmation does not match password!')]")
    ...
    public String getPasswordMismatchWarning() {
        return getElementText(warnPasswordMismatch).trim();
    }
        ...
        try {
            ...
            try {
                WebElement pwdError = driver.findElement(
                        By.xpath(
                                "//input[@id='input-password']/following-sibling::div[contains(@class,'text-danger')]"
                        )
                );
            ...
            try {
                WebElement confirmError = driver.findElement(
                        By.xpath(
                                "//input[@id='input-confirm']/following-sibling::div[contains(@class,'text-danger')]"
                        )
                );
    ...
    public String getTelephoneWarning() {
        ...
        return getElementText(warningTelephone);
    }
}
...
public class TC_AB_002_ValidateAddressBookRightColumnNavigationTest extends BaseClass {
    ...
    public void verifyAddressBookNavigation() {
        ...
        // FIX: Initialize Page Objects after the getDriver() is established by performLogin()

        homePage = new HomePage(getDriver());
        myAccountPage = new MyAccountPage(getDriver());
        addressBookPage = new AddressBookPage(getDriver());

        //Click on Address Book link from the My Account Right Column
        ...
        //Verify Address Book page is displayed
        try {

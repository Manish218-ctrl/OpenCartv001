...
import testBase.BaseClass;
    ...
    public class TC_CU_007_ValidateContactUsNoDetailsSubmittedTest extends BaseClass {
        ...
        public void validateNoDetailsSubmitted() {
          ...
          /*  WebElement nameError = driver.findElement(By.cssSelector("div.text-danger[name='name']"));
            WebElement emailError = driver.findElement(By.cssSelector("div.text-danger[name='email']"));
            WebElement enquiryError = driver.findElement(By.cssSelector("div.text-danger[name='enquiry']"));*/

...
import testBase.BaseClass;
    ...
    public class TC_CP_008_ValidateChangePasswordHideTextTest extends BaseClass {
        ...
        public void validatePasswordFieldMasking() {
            ...
            getDriver().get(appURL + "/index.php?route=account/password"); // Adjust if needed
            logger.info("Navigated to Change Password page.");

            //Enter sample password in New Password and Confirm Password
            ...
            //Validate that text is hidden (masked)

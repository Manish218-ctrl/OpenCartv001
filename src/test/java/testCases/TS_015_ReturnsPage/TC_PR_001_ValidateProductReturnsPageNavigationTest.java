...
public class TC_PR_001_ValidateProductReturnsPageNavigationTest extends BaseClass {
    ...
    public void validateNavigatingToProductReturnsPage() {
        ...
        logger.info("Opening the application and navigating to the Login page.");
        getDriver().get(appURL);

        //Click on My Account to open the account menu and then click on Login
        logger.info("Clicking on My Account and then clicking Login from the dropdown.");
        ...
        //Navigate to My Account page and click View your return requests
        logger.info("Navigating to My Account page and clicking View your return requests.");
        ...
        //Validate navigation to Product Returns page
        logger.info("Validating navigation to the Product Returns page.");
        ...
        logger.info("Validating the Product Returns page title.");

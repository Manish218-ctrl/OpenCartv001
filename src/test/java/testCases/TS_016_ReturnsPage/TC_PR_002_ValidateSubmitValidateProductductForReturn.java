...
public class TC_PR_002_ValidateSubmitValidateProductductForReturn extends BaseClass {

    @Test
    public void validateSubmitProductForReturn() throws InterruptedException {
        logger.info("========== Starting Test Case: TC_PR_002_ValidateSubmitValidateProductductForReturn ==========");
        ...
        logger.info("========== Test Case TC_PR_002_ValidateSubmitValidateProductductForReturn Completed ==========");
    }
}

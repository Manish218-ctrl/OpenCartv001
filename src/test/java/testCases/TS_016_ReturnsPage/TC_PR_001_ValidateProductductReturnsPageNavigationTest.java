...
public class TC_PR_001_ValidateProductductReturnsPageNavigationTest extends BaseClass {
    ...
    public void validateNavigatingToProductReturnsPage() {
        ...
        // Click My Account
        homepage.clickLogin();      // Click Login link
        ...
        // Step 4: Navigate to 'My Account' page and click 'View your return requests'
        logger.info("Step 4: Navigating to 'My Account' page and clicking 'View your return requests'.");
        ...
        // Step 5: Validate navigation to 'Product Returns' page
        logger.info("Step 5: Validating navigation to the 'Product Returns' page.");
        ...
        logger.info("Step 6: Validating the Product Returns page title.");

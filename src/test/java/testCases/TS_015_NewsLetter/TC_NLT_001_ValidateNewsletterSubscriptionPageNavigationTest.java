...
public class TC_NLT_001_ValidateNewsletterSubscriptionPageNavigationTest extends BaseClass {
    ...
    public void validateNewsletterPage() throws InterruptedException {
        ...
        // Step 2: Login to the application using the method from BaseClass
        logger.info("Step 2: Logging into the application using credentials.");
        performLogin();  // This uses the login functionality already present in BaseClass
        ...
        // Step 10: Optionally, verify the URL after clicking Continue or confirm successful subscription.
        logger.info("Step 10: Verifying the URL after clicking 'Continue'.");
        String currentUrl = driver.getCurrentUrl();
        Assert.assertTrue(currentUrl.contains("newsletter/confirmation"), "Incorrect URL after continue. Current URL: " + currentUrl);
        logger.info("URL verified successfully: " + currentUrl);

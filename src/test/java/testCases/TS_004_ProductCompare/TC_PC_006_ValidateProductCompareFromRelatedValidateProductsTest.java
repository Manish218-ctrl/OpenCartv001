...
import testBase.BaseClass;
    ...
    public class TC_PC_006_ValidateProductCompareFromRelatedValidateProductsTest extends BaseClass {

        @Test(groups = {"regression", "sanity"})
        public void verifyProductCompareFromRelatedProducts() {
            logger.info("***** Starting TC_PC_006_ValidateProductCompareFromRelatedValidateProductsTest *****");
            ...
            logger.info("***** Finished TC_PC_006_ValidateProductCompareFromRelatedValidateProductsTest *****");
        }
    }

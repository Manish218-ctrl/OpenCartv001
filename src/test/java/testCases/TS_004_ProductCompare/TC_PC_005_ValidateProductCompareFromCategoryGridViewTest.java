...
public class TC_PC_005_ValidateProductCompareFromCategoryGridViewTest extends BaseClass {
    ...
    public void verifyProductCompareFromCategoryGridView() {
        ...
        try {
            ...
            //Verify that the current view is the intended Grid View
            ...
            // Get the first product card, which includes a wait for visibility.
            WebElement firstProductCard = sp.getFirstProductCard();
            logger.info("First Product Card is visible.");

            // SCROLL TO THE TARGET CARD: Ensure the card is in the viewport.
            sp.scrollHover(firstProductCard);
            logger.info("Scrolled to make the first product card visible.");

            // Wait for the nested product name link to be visible within the card.
            ...
            // Validate tooltip on Compare button
            ...
            // Validate success message (use explicit wait for the success alert)

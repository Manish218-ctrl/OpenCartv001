...
public class TC_LG_009_ValidateUILayoutOfValidateLogoutAndValidateLogoutPageTest extends BaseClass {
    ...
    public void test_validate_logout_ui_and_logout_page() {
        logger.info("Starting TC_LG_009_ValidateUILayoutOfValidateLogoutAndValidateLogoutPageTest: Validate UI of Logout option and Account Logout page.");
        ...
        try {
            ...
            logger.error("Test execution failed for TC_LG_009_ValidateUILayoutOfValidateLogoutAndValidateLogoutPageTest: " + e.getMessage());
            Assert.fail("Test failed due to an exception: " + e.getMessage());
        } finally {
            logger.info("Finished TC_LG_009_ValidateUILayoutOfValidateLogoutAndValidateLogoutPageTest.");
        }
    }
}

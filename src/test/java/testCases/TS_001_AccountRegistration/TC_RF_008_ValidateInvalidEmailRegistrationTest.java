...
public class TC_RF_008_ValidateInvalidEmailRegistrationTest extends BaseClass {
    ...
    public void verify_registration_with_invalid_emails() {
        ...
        logger.info(
                "***** Starting TC_RF_008_ValidateInvalidEmailRegistrationTest *****"
        );
        ...
        try {
            ...
            for (String invalidEmail : invalidEmails) {
                ...
                String warning =
                        regPage.getEmailInvalidWarning();
                ...
                Assert.assertEquals(
                        ...
                        "Invalid email warning not displayed correctly for: "
                                + invalidEmail
                );
        ...
        logger.info(
                "***** Finished TC_RF_008_ValidateInvalidEmailRegistrationTest *****"
        );
    }
}
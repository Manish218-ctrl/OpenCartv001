...
public class TC_SF_008_ValidateSearchPlaceholderTest extends BaseClass {
    ...
    public void verifySearchPlaceholders() {
        ...
        try {
            ...
            getDriver().get( "https://tutorialsninja.com/demo/index.php?route=product/search"); // adjust if needed
            searchPage = new SearchPage(getDriver()); // re-init PageFactory for new page

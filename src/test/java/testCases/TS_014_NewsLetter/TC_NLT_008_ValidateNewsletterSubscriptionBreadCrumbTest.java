...
public class TC_NLT_008_ValidateNewsletterSubscriptionBreadCrumbTest extends BaseClass {
    ...
    public void validateNewsletterSubscriptionPage() {
        ...
        // 1. Perform Login (sets up WebgetDriver() and logs in)
        performLogin();

        // 2. Initialize Page Objects using the inherited getDriver() instance
        ...
        //Click on Newsletter link from the right column of the HomePage
        logger.info("Clicking on the Newsletter link from the right column.");
        try {
        ...
        logger.info("Validating the Page Heading.");
        ...
        logger.info("Validating the Breadcrumb.");
